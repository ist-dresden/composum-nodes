...
public class SetupHook implements InstallHook {
    ...
    public void execute(InstallContext ctx) throws PackageException {
        ...
        switch (ctx.getPhase()) {
            case INSTALLED:
                LOG.info("Nodes installed: execute...");
                moveClientlibsRoot(ctx);
                LOG.info("Nodes installed: execute ends.");
                break;
        }
    }
    ...
    protected void moveClientlibsRoot(InstallContext ctx) throws PackageException {
        try {
            ...
            try {
                ...
                LOG.info("Nodes clientlibs: move clientlibs root...");
                ...
                try {
                    ...
                    LOG.info("Nodes clientlibs: move from '" + VAR_CACHE + "' to '" + VAR_COMPOSUM + "'");
                    ...
                    if (!cache.getNodes().hasNext()) {
                        LOG.info("Nodes clientlibs: delete '" + VAR_CACHE + "'");
