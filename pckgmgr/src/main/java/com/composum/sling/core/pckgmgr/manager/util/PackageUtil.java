package com.composum.sling.core.pckgmgr.manager.util;
...
public class PackageUtil {
    ...
    public enum TreeType {
        packages, registries, registry, group, jcrpckg, regpckg, version
    }
    ...
    public static TreeType getTreeType(JcrPackageManager manager, SlingHttpServletRequest request, String path) {
        ...
        try {
            ...
            if (jcrPackage != null) {
                type = TreeType.valueOf(Packages.getMode(request).name());
            } else {
