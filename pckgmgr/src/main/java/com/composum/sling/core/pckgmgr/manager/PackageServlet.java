package com.composum.sling.core.pckgmgr.manager;
...
import com.composum.sling.core.pckgmgr.manager.service.impl.PackageJobExecutor;
...
import com.composum.sling.core.pckgmgr.registry.tree.RegistryItem;
import com.composum.sling.core.pckgmgr.registry.tree.RegistryTree;
...
public class PackageServlet extends AbstractServiceServlet {
    ...
    protected class RegistryTreeOperation implements ServletOperation {
        ...
        public void doIt(@Nonnull final SlingHttpServletRequest request,
            ...
            RegistryTree tree = new RegistryTree(RequestUtil.checkSelector(request, "merged"));
            String path = PackageUtil.getPath(request);
