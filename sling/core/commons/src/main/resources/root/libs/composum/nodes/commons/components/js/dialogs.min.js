(function(c){c.components=c.components||{};(function(d){d.Dialog=Backbone.View.extend({initialize:function(a){this.$alert=this.$(".alert");this.setUpWidgets(this.el);this.$el.on("shown.bs.modal",_.bind(this.onShown,this))},setUpWidgets:function(a){d.setUp(a)},widgetOf:function(a){return c.widgetOf(a)},show:function(a,b){this.initView=a;this.callback=b;this.$el.modal("show")},onShown:function(){this.resetOnShown();_.isFunction(this.initView)&&this.initView()},resetOnShown:function(){this.reset()},
hide:function(){this.$el.modal("hide");_.isFunction(this.callback)&&this.callback();this.reset()},reset:function(){this.alert();this.$("input,textarea,select").each(function(){"radio"!=this.type&&$(this).val(void 0)});this.$(".widget").each(function(){this.view&&_.isFunction(this.view.reset)&&this.view.reset.apply(this.view)})},alert:function(a,b,e){this.$alert.removeClass();b?(this.$alert.html(e?c.resultMessage(e,b):b),this.$alert.addClass("alert").addClass("alert-"+a)):(this.$alert.html(""),this.$alert.addClass("alert").addClass("alert-hidden"))},
submitForm:function(a,b,e){c.submitForm(this.el,_.bind(function(b){_.isFunction(a)&&a(b);this.hide()},this),_.bind(function(a){_.isFunction(b)?b(a):(void 0===b||b)&&this.alert("danger","Error on submit",a)},this),e)},submitFormPut:function(a,b,e){var d=c.getWidget(this.el,"form.widget-form",c.components.FormWidget);c.submitFormPut(this.el,d?d.getValues.apply(d):void 0,_.bind(function(b){_.isFunction(a)&&a(b);this.hide()},this),_.bind(function(a){_.isFunction(b)?b(a):(void 0===b||b)&&this.alert("danger",
"Error on submit",a)},this),e)},submitPUT:function(a,b,d,f){c.ajaxPut(b,JSON.stringify(d),{dataType:"json"},f,void 0,_.bind(function(b){200==b.status?(_.isFunction(f)&&f(b),this.hide()):this.alert("danger","Error on "+a,b)},this))}});d.SelectPathDialog=d.Dialog.extend({initialize:function(a){d.Dialog.prototype.initialize.apply(this,[a]);this.busy=!1;this.tree=c.getView(this.$(".path-select-tree"),d.Tree);this.tree.onNodeSelected=_.bind(this.onNodeSelected,this);this.$title=this.$(".modal-title");
