(function(c){c.components=c.components||{};(function(d){d.CodeEditorWidget=Backbone.View.extend({initialize:function(a){this.$editor=this.$(".code-editor");this.$findText=this.$(".search .find-text");this.$findNext=this.$(".search .find-next");this.$findPrev=this.$(".search .find-prev");this.$matchCase=this.$(".match-case");this.$findRegEx=this.$(".find-regex");this.$replText=this.$(".replace .replace-text");this.$replCurrent=this.$(".replace .replace");this.$replAll=this.$(".replace .replace-all");
this.$undo=this.$(".undo");this.$redo=this.$(".redo");this.initEditor(_.bind(function(a){this.ace.setReadOnly(!0);this.ace.navigateFileStart()},this));this.$el.resize(_.bind(this.resize,this));this.$(".editor-toolbar .start-editing").click(_.bind(this.openEditDialog,this));this.searchOptions={wrap:!0,caseSensitive:!1,regExp:!1};this.$findText.on("input",_.bind(function(a){this.findText()},this));this.$findText.keypress(_.bind(function(a){this.findText()},this));this.$findNext.click(_.bind(this.findNext,
this));this.$findPrev.click(_.bind(this.findPrev,this));this.$matchCase.change(_.bind(this.toggleCaseSensitive,this));this.$findRegEx.change(_.bind(this.toggleRegExp,this));this.$replCurrent.click(_.bind(this.replace,this));this.$replAll.click(_.bind(this.replaceAll,this));this.$undo.click(_.bind(this.undo,this));this.$redo.click(_.bind(this.redo,this))},initEditor:function(a){this.ace=ace.edit(this.$editor[0]);this.ace.setTheme("ace/theme/clouds");var b=this.$editor.attr("data-type");b&&this.ace.getSession().setMode("ace/mode/"+
b);this.loadText(a)},setSaveCommand:function(a){this.ace.commands.addCommand({name:"save",bindKey:{win:"Ctrl-S",mac:"Command-S"},exec:a})},getValue:function(){return this.ace.getValue()},setValue:function(a,b){this.ace.setValue(a);b&&this.$el.trigger("change")},openEditDialog:function(){this.dialog=c.getView("#text-edit-dialog",d.CodeEditorDialog);this.dialog.editSource(this)},getPath:function(){return this.$editor.attr("data-path")},loadText:function(a){var b=this.getPath();b&&c.ajaxGet("/bin/cpm/nodes/property.bin"+
b,{contentType:"text/plain;charset=UTF-8",dataType:"text"},_.bind(function(b){this.ace.setValue(b);this.ace.clearSelection();_.isFunction(a)&&a(b)},this),_.bind(function(a){c.alert("danger","Error","Error on loading text",a)},this))},saveText:function(a){var b=this.getPath();b&&c.ajaxPut("/bin/cpm/nodes/property.bin"+b,this.ace.getValue(),{contentType:"text/plain;charset=UTF-8",dataType:"text"},void 0,void 0,_.bind(function(b,d,e){200==b.status?_.isFunction(a)&&a(b):c.alert("danger","Error","Error on updating text",
