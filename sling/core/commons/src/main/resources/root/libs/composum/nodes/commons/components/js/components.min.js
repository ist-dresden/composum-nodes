...
reset:function(){this.valid=void 0;this.$textField.closest(".form-group").removeClass("has-error");this.$textField.val(void 0)}});d.register(".widget.text-field-widget",c.TextFieldWidget);c.TextAreaWidget=d.Widget.extend({initialize:function(a){d.Widget.prototype.initialize.apply(this,[a]);this.initRules(this.$input);this.rules&&(this.$input.on("keyup.validate",_.bind(this.validate,this)),this.$input.on("change.validate",_.bind(this.validate,this)))},retrieveInput:function(){return this.$el.is("textarea")?
