...
new Date(a):void 0);this.validate();b&&this.$el.trigger("change")}});d.register(".widget.date-time-widget",c.DateTimeWidget);c.FileUploadWidget=c.TextFieldWidget.extend({initialize:function(a){c.TextFieldWidget.prototype.initialize.apply(this,[a]);var b=this.$el.data("options");b&&(0<=b.indexOf("hidePreview")&&(a.showPreview=!1,a.showUploadedThumbs=!1),0<=b.indexOf("showUpload")&&(a.showUpload=!0));if(b=this.$el.data("type"))a.fileType=b;this.$textField.fileinput({showPreview:void 0===a.showPreview?
!0:a.showPreview,showUpload:a.showUpload||!1,fileType:a.fileType||"any"})},setValue:function(a){}});d.register(".widget.file-upload-widget",c.FileUploadWidget);c.PropertyNameWidget=c.TextFieldWidget.extend({initialize:function(a){c.TextFieldWidget.prototype.initialize.apply(this,[a]);this.$textField.typeahead({minLength:1,source:"jcr:data jcr:description jcr:lastModified jcr:lastModifiedBy jcr:mixinTypes jcr:primaryType jcr:title sling:redirect sling:resourceType".split(" ")})}});d.register(".widget.property-name-widget",
c.PropertyNameWidget);c.RepositoryNameWidget=c.TextFieldWidget.extend({nameChanged:function(a,b){"jcr:primaryType"==a?b.setWidgetType.apply(b,["jcr-primaryType"]):"jcr:mixinTypes"==a&&b.setWidgetType.apply(b,["jcr-mixinTypes"])}});d.register(".widget.repository-name-widget",c.RepositoryNameWidget);c.PrimaryTypeWidget=c.TextFieldWidget.extend({initialize:function(a){c.TextFieldWidget.prototype.initialize.apply(this,[a]);this.$textField.attr("autocomplete","off");this.$textField.typeahead({minLength:1,
source:function(a,c){e.ajaxGet("/bin/cpm/core/system.primaryTypes.json",{query:a},function(a){c(a)})}})}});d.register(".widget.primary-type-widget",c.PrimaryTypeWidget);c.MixinTypeWidget=c.TextFieldWidget.extend({initialize:function(a){c.TextFieldWidget.prototype.initialize.apply(this,[a]);this.$textField.attr("autocomplete","off");this.$textField.typeahead({minLength:1,source:function(a,c){e.ajaxGet("/bin/cpm/core/system.mixinTypes.json",{query:a},function(a){c(a)})}})}});d.register(".widget.mixin-type-widget",
c.MixinTypeWidget)})(e.components,window.widgets)})(window.core);
