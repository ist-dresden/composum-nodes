...
$jscomp.iteratorPrototype=function(b){$jscomp.initSymbolIterator();b={next:b};b[$jscomp.global.Symbol.iterator]=function(){return this};return b};$jscomp.array=$jscomp.array||{};$jscomp.iteratorFromArray=function(b,d){$jscomp.initSymbolIterator();b instanceof String&&(b+="");var a=0,c={next:function(){if(a<b.length){var e=a++;return{value:d(e,b[e]),done:!1}}c.next=function(){return{done:!0,value:void 0}};return c.next()}};c[Symbol.iterator]=function(){return c};return c};
...
$jscomp.findInternal=function(b,d,a){b instanceof String&&(b=String(b));for(var c=b.length,e=0;e<c;e++){var f=b[e];if(d.call(a,f,e,b))return{i:e,v:f}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(b){return b?b:function(b,a){return $jscomp.findInternal(this,b,a).v}},"es6-impl","es3");
(function(b){b.components=b.components||{};(function(d){d.MultiFormItem=Backbone.View.extend({initialize:function(a){},getValue:function(){var a={};this.$(".widget").each(function(){if(this.view&&_.isFunction(this.view.getValue)){var c=b.getWidgetName(this.view);c&&(a[c]=this.view.getValue.apply(this.view))}});var c=_.values(a);1==c.length&&(a=c[0]);return a},setValue:function(a){this.$(".widget").each(function(){if(this.view&&_.isFunction(this.view.setValue)){var c=b.getWidgetName(this.view);this.view.setValue.apply(this.view,
...
this.$(".action-bar button.add").unbind("click").on("click",_.bind(this.add,this));this.$(".action-bar button.remove").unbind("click").on("click",_.bind(this.remove,this));this.$(".action-bar button.move-up").unbind("click").on("click",_.bind(this.moveUp,this));this.$(".action-bar button.move-down").unbind("click").on("click",_.bind(this.moveDown,this))},getValue:function(){for(var a=[],c=0;c<this.itemList.length;c++){var e=this.itemList[c].getValue();(c<this.itemList.length-1||!b.isEmptyObject(e))&&
a.push(e)}return a},setValue:function(a){if(a){this.reset(a.length);for(var c=0;c<this.itemList.length;c++)this.itemList[c].setValue(a[c])}else this.reset(0)},reset:function(a){if(!a||1>a)a=1;for(;this.itemList.length>a;)this.remove();for(var c=0;c<this.itemList.length;c++)this.itemList[c].reset();for(;this.itemList.length<a;)this.add()},newItem:function(a){return b.getView(a,this.itemType,_.bind(function(a){0==a.$(".item-select").length&&a.$el.prepend('<input class="item-select form-control" type="radio" name="item-select-'+
this.name+'">');a.$(".item-select").unbind("click").on("click",_.bind(this.onSelect,this));d.setUp(a.el)},this),this.itemType!=d.MultiFormItem)},onSelect:function(a){a=$(a.currentTarget).closest(".multi-form-item")[0];for(var c=0;c<this.itemList.length;c++)if(a===this.itemList[c].el){this.itemList[c].$(".item-select").unbind("click");this.current(this.itemList[c]);this.itemList[c].$(".item-select").on("click",_.bind(this.onSelect,this));break}},indexOf:function(a){return _.indexOf(this.itemList,a)},
current:function(a){if(a&&0<=this.indexOf(a)){this.currentItem=a;for(a=0;a<this.itemList.length;a++)this.itemList[a].$el.removeClass("current"),this.itemList[a].$(".item-select").attr("value",a);this.currentItem.$el.addClass("current");this.currentItem.$(".item-select").click()}return this.currentItem},add:function(){var a=this.currentItem,c=this.itemList[this.itemList.length-1],b=_.isFunction(c.clone)?c.clone():c.$el.clone();c.$el.parent().append(b);c=this.newItem(b);c.reset();this.itemList[this.itemList.length]=
c;this.current(a)},remove:function(){if(1<this.itemList.length){var a=this.indexOf(this.currentItem);a==this.itemList.length-1&&a--;this.currentItem.$el.remove();this.itemList=_.without(this.itemList,this.currentItem);this.current(this.itemList[a])}else this.itemList[0].reset()},moveUp:function(){var a=this.indexOf(this.currentItem);if(0<a){var c=1<a?_.first(this.itemList,a-1):[],b=a<this.itemList.length-1?_.rest(this.itemList,a+1):[];this.itemList=_.union(c,[this.currentItem],[this.itemList[a-1]],
b);this.currentItem.$el.insertBefore(this.currentItem.$el.prev())}},moveDown:function(){var a=this.indexOf(this.currentItem);if(a<this.itemList.length-1){var b=0<a?_.first(this.itemList,a):[],d=a<this.itemList.length-2?_.rest(this.itemList,a+2):[];this.itemList=_.union(b,[this.itemList[a+1]],[this.currentItem],d);this.currentItem.$el.insertAfter(this.currentItem.$el.next())}},getWidgetValue:function(a){var c=b.widgetOf(a,this);return c&&_.isFunction(c.getValue)?c.getValue():a.val()},setWidgetValue:function(a,
c){var d=b.widgetOf(a,this);d&&_.isFunction(d.setValue)?d.setValue(c):a.val(c)}})})(b.components)})(window.core);
