...
(function(c){c.widgets={"const":{css:{base:"widget",selector:{general:".widget",prefix:".widget.",form:"form.form-widget"}},attr:{name:"name"}},registered:{},register:function(a,b,d){widgets.registered[a]=_.extend({selector:a,widgetClass:b},d)},setUp:function(a){var b=$(a);_.keys(widgets.registered).forEach(function(a){b.find(a).each(function(){core.getView(this,widgets.registered[a].widgetClass)})})},apply:function(a,b){_.keys(widgets.registered).forEach(function(d){d=widgets.registered[d];var c=
