...
d.responseText.substring(d.previous_text_length);f(d,a)}};d.previous_text_length=0;d.onreadystatechange=function(){if(2<d.readyState){var a=d.responseText.substring(d.previous_text_length);_.isFunction(c)&&c(d,a);d.previous_text_length=d.responseText.length}};d.open(a,core.getContextUrl(b),!0);d.send()},getRequest:function(a,b,d,c,f){core.ajaxGet(b,{dataType:a},d,c,f)},submitForm:function(a,b,c,e){var d=$(a);d.is("form")||(d=d.find("form"));var g=d.attr("action"),d=new FormData(d[0]);$.ajax({type:"POST",
url:core.getContextUrl(g),data:d,cache:!1,contentType:!1,processData:!1,success:function(a){_.isFunction(b)&&b(a)},error:function(d){core.isNotAuthorized(d)&&_.isFunction(core.unauthorizedDelegate)?core.unauthorizedDelegate(function(){core.submitForm(a,b,c,e)}):200>d.status||299<d.status?_.isFunction(c)&&c(d):_.isFunction(b)&&b(d)},complete:function(a){core.isNotAuthorized(a)&&_.isFunction(core.unauthorizedDelegate)||_.isFunction(e)&&e(a)}})},submitFormPut:function(a,b,d,c,f){var e=$(a);e.is("form")||
(e=e.find("form"));var l=e.attr("action");if(!b){b={};for(var e=new FormData(e[0]),m=e.keys(),h;!(h=m.next()).done;){var k=e.getAll(h.value);b[h.value]=1==k.length?k[0]:k}}$.ajax({type:"PUT",url:core.getContextUrl(l),data:JSON.stringify(b),dataType:"json",cache:!1,contentType:!1,processData:!1,success:function(a){_.isFunction(d)&&d(a)},error:function(e){core.isNotAuthorized(e)&&_.isFunction(core.unauthorizedDelegate)?core.unauthorizedDelegate(function(){core.submitFormPut(a,b,d,c,f)}):200>e.status||
299<e.status?_.isFunction(c)&&c(e):_.isFunction(d)&&d(e)},complete:function(a){core.isNotAuthorized(a)&&_.isFunction(core.unauthorizedDelegate)||_.isFunction(f)&&f(a)}})},isNotAuthorized:function(a){return 401==a.status||403==a.status},resultMessage:function(a,b){var d=/<title>(.+)<\/title>/im.exec(a.responseText);return(b?b+" - ":"")+a.status+": "+a.statusText+(d?"\n\n("+d[1]+")":"")},getContextUrl:function(a){var b=$("html").data("context-path");b&&0!=a.indexOf(b)&&(a=b+a);return a},getView:function(a,
b,d,e){return c.core.getWidget(document,a,b,d,e)},getWidget:function(a,b,d,c,f){if((b="string"===typeof b?$(a).find(b):$(b))&&0<b.length){b=b[0];if(!b.view||f)f={el:b},c&&!_.isFunction(c)&&(f=_.extend(c,f)),b.view=new d(f),_.isFunction(c)&&c.apply(b.view,[b.view]);return b.view}},widgetOf:function(a,b){a="string"===typeof a?b?b.$(a):$(a):$(a);var c=a.closest(".widget");if(c&&0<c.length)return c[0].view},getWidgetName:function(a){var b;_.isFunction(a.getName)&&(b=a.getName.apply(a));b||(b=a.$el.attr("name"));
b||(b=a.$el.data("name"));b||(b=a.$el.find("[name]").attr("name"));return b},alert:function(a,b,c,e){var d=core.getView("#alert-dialog",core.components.Dialog);d.$(".modal-header h4").text(b||"Alert");d.show(_.bind(function(){d.alert(a,c,e)},this))},buildContentPath:function(a,b){a&&0<a.length?"/"!=a.charAt(a.length-1)&&(a+="/"):a="/";0==b.indexOf("/")&&(b=b.substring(1));return a+b},getNameFromPath:function(a){var b=a.lastIndexOf("/");return 0<=b?a.substring(b+1):a},getParentPath:function(a){var b=
a.lastIndexOf("/");return a.substring(0,0<b?b:b+1)},encodePath:function(a){a=encodeURI(a);a=a.replace("&","%26");a=a.replace(";","%3B");a=a.replace(":","%3A");return a=a.replace(".","%2E")},isEmptyObject:function(a){for(var b=_.values(a),c=0;c<b.length;c++)if(b[c])return!1;return _.isObject(a)||!a}}})(window);
