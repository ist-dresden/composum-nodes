...
$jscomp.polyfill("String.prototype.endsWith",function(c){return c?c:function(a,b){var d=$jscomp.checkStringArgs(this,a,"endsWith");a+="";void 0===b&&(b=d.length);for(var e=Math.max(0,Math.min(b|0,d.length)),c=a.length;0<c&&0<e;)if(d[--e]!=a[--c])return!1;return 0>=c}},"es6-impl","es3");
...
var e=d[b];if(_.isFunction(e)){var c=$(a);c.is(d.selector)?e.apply(a):c.find(d.selector).each(function(){e.apply(this)})}})},Widget:Backbone.View.extend({initialize:function(a){this.$input=this.retrieveInput();this.name=this.retrieveName();this.form=this.retrieveForm()},retrieveInput:function(){return this.$el.is("input")?this.$el:this.$("input")},retrieveName:function(){return this.$input.attr(widgets["const"].attr.name)},declareName:function(a){a?this.$input.attr(widgets["const"].attr.name,a):this.$input.removeAttr(widgets["const"].attr.name)},
...
(this.valid=_.isFunction(this.validate)?this.validate(a):!0);this.alertFlush(a);return this.valid},validationReset:function(){this.alertMessage=this.valid=void 0},grabFocus:function(){this.$input.focus()},alert:function(a,b,d,e,c){_.isFunction(a)?a(b,d||this.label,e,c):this.alertMessage={type:b,label:d,message:e,hint:c}},alertFlush:function(a){_.isFunction(a)&&this.alertMessage&&(a(this.alertMessage.type,this.alertMessage.label||this.label,this.alertMessage.message,this.alertMessage.hint),this.alertMessage=
void 0)}})};c.widgets.register(".widget.hidden-widget",c.widgets.Widget);c.core={getHtml:function(a,b,d,c){core.ajaxGet(a,{dataType:"html"},b,d,c)},getJson:function(a,b,d,c){core.ajaxGet(a,{dataType:"json"},b,d,c)},ajaxHead:function(a,b,d,c,f){a=_.extend({type:"HEAD",url:core.getContextUrl(a)},b);core.ajaxCall(a,d,c,f)},ajaxGet:function(a,b,d,c,f){a=_.extend({type:"GET",url:core.getContextUrl(a)},b);core.ajaxCall(a,d,c,f)},ajaxPost:function(a,b,d,c,f,g){a=_.extend({type:"POST",url:core.getContextUrl(a),
data:b},d);core.ajaxCall(a,c,f,g)},ajaxPut:function(a,b,c,e,f,g){a=_.extend({type:"PUT",contentType:!1,url:core.getContextUrl(a),data:b},c);core.ajaxCall(a,e,f,g)},ajaxDelete:function(a,b,c,e,f){a=_.extend({type:"DELETE",contentType:!1,url:core.getContextUrl(a)},b);core.ajaxCall(a,c,e,f)},ajaxCall:function(a,b,c,e){var d=_.extend({async:!0,cache:!1,success:function(a,c,d){_.isFunction(b)&&b(a,c,d)},error:function(d){core.isNotAuthorized(d)&&_.isFunction(core.unauthorizedDelegate)?core.unauthorizedDelegate(function(){core.ajaxCall(a,
b,c,e)}):200>d.status||299<d.status?_.isFunction(c)&&c(d):_.isFunction(b)&&b(d)},complete:function(a){core.isNotAuthorized(a)&&_.isFunction(core.unauthorizedDelegate)||_.isFunction(e)&&e(a)}},a);$.ajax(d)},ajaxPoll:function(a,b,c,e,f){var d=new XMLHttpRequest;d.onload=function(){if(_.isFunction(e)){var a=d.responseText.substring(d.previous_text_length);e(d,a)}};d.onerror=function(){if(_.isFunction(f)){var a=d.responseText.substring(d.previous_text_length);f(d,a)}};d.previous_text_length=0;d.onreadystatechange=
function(){if(2<d.readyState){var a=d.responseText.substring(d.previous_text_length);_.isFunction(c)&&c(d,a);d.previous_text_length=d.responseText.length}};d.open(a,core.getContextUrl(b),!0);d.send()},getRequest:function(a,b,d,c,f){core.ajaxGet(b,{dataType:a},d,c,f)},submitForm:function(a,b,d,c){var e=$(a);e.is("form")||(e=e.find("form"));var g=e.attr("action"),e=new FormData(e[0]);$.ajax({type:"POST",url:core.getContextUrl(g),data:e,cache:!1,contentType:!1,processData:!1,success:function(a){_.isFunction(b)&&
b(a)},error:function(e){core.isNotAuthorized(e)&&_.isFunction(core.unauthorizedDelegate)?core.unauthorizedDelegate(function(){core.submitForm(a,b,d,c)}):200>e.status||299<e.status?_.isFunction(d)&&d(e):_.isFunction(b)&&b(e)},complete:function(a){core.isNotAuthorized(a)&&_.isFunction(core.unauthorizedDelegate)||_.isFunction(c)&&c(a)}})},submitFormPut:function(a,b,c,e,f){var d=$(a);d.is("form")||(d=d.find("form"));var l=d.attr("action");if(!b){b={};for(var d=new FormData(d[0]),m=d.keys(),h;!(h=m.next()).done;){var k=
d.getAll(h.value);b[h.value]=1==k.length?k[0]:k}}$.ajax({type:"PUT",url:core.getContextUrl(l),data:JSON.stringify(b),dataType:"json",cache:!1,contentType:!1,processData:!1,success:function(a){_.isFunction(c)&&c(a)},error:function(d){core.isNotAuthorized(d)&&_.isFunction(core.unauthorizedDelegate)?core.unauthorizedDelegate(function(){core.submitFormPut(a,b,c,e,f)}):200>d.status||299<d.status?_.isFunction(e)&&e(d):_.isFunction(c)&&c(d)},complete:function(a){core.isNotAuthorized(a)&&_.isFunction(core.unauthorizedDelegate)||
_.isFunction(f)&&f(a)}})},isNotAuthorized:function(a){return 401==a.status||403==a.status},resultMessage:function(a,b){var d=/<title>(.+)<\/title>/im.exec(a.responseText);return(b?b+" - ":"")+a.status+": "+a.statusText+(d?"\n\n("+d[1]+")":"")},getContextUrl:function(a){var b=$("html").data("context-path");b&&0!=a.indexOf(b)&&(a=b+a);return a},getView:function(a,b,d,c){return core.getWidget(document,a,b,d,c)},getWidget:function(a,b,c,e,f){if((b="string"===typeof b?$(a).find(b):$(b))&&0<b.length){b=
b[0];if(!b.view||f)f={el:b},e&&!_.isFunction(e)&&(f=_.extend(e,f)),b.view=new c(f),_.isFunction(e)&&e.apply(b.view,[b.view]);return b.view}},widgetOf:function(a,b){a="string"===typeof a?b?b.$(a):$(a):$(a);var c=a.closest(".widget");if(c&&0<c.length)return c[0].view},getWidgetName:function(a){var b;_.isFunction(a.getName)&&(b=a.getName.apply(a));b||(b=a.$el.attr("name"));b||(b=a.$el.data("name"));b||(b=a.$el.find("[name]").attr("name"));return b},getWidgetNames:function(a,b){return core.splitWidgetName(core.getWidgetName(a))},
splitWidgetName:function(a,b){b||(b=0<=a.indexOf("/")?"/":".");return a.split(b)},alert:function(a,b,c,e){var d=core.getView("#alert-dialog",core.components.Dialog);d.$(".modal-header h4").text(b||"Alert");d.show(_.bind(function(){d.alert(a,c,e)},this))},buildContentPath:function(a,b){a&&0<a.length?"/"!=a.charAt(a.length-1)&&(a+="/"):a="/";0==b.indexOf("/")&&(b=b.substring(1));return a+b},getNameFromPath:function(a){var b=a.lastIndexOf("/");return 0<=b?a.substring(b+1):a},getParentPath:function(a){var b=
a.lastIndexOf("/");return a.substring(0,0<b?b:b+1)},encodePath:function(a){a=encodeURI(a);a=a.replace("&","%26");a=a.replace(";","%3B");a=a.replace(":","%3A");return a=a.replace(".","%2E")},isEmptyObject:function(a){for(var b=_.values(a),c=0;c<b.length;c++)if(b[c])return!1;return _.isObject(a)||!a},addPathSegment:function(a,b){b&&(0<a.length&&!a.endsWith("/")&&0!=b.indexOf("/")&&(a+="/"),a+=b,core.endsWith(a,"/")||(a+="/"));return a},endsWith:function(a,b){return a.lastIndexOf(b)==a.length-b.length}};
c.core.LocalProfile=function(a){this.profileKey=a;this.aspects={}};_.extend(c.core.LocalProfile.prototype,{get:function(a,b,c){var d=this.aspects[a];if(!d){var f=localStorage.getItem(this.profileKey+"."+a);f&&(d=JSON.parse(f),this.aspects[a]=d)}a=void 0;d&&(a=b?d[b]:d);return void 0!==a?a:c},set:function(a,b,c){var d=this.get(a,void 0,{});b?d[b]=c:d=c;this.aspects[a]=d;this.save(a)},save:function(a){var b=this.aspects[a];b&&localStorage.setItem(this.profileKey+"."+a,JSON.stringify(b))}})})(window);
