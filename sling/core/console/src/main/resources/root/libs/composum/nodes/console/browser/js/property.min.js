...
[b]);this.form=a.getWidget(this.el,"form.widget-form",a.components.FormWidget);this.$title=this.$("h4.modal-title");this.$path=this.$('input[name="path"]');this.$oldname=this.$('input[name="oldname"]');this.$name=this.$('input[name="name"]');this.$type=this.$('select[name="type"]');this.$subtype=this.$(".subtype");this.subtype=a.getWidget(this.$subtype,".widget.combo-box-widget",a.components.ComboBoxWidget);this.$multi=this.$('input[name="multi"]');this.valueWidget=a.getWidget(this.$el,".widget.property-value-widget",
