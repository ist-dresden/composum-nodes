...
<cpn:component id="browser" type="com.composum.sling.nodes.browser.Browser" scope="request">
  <div class="node-view-panel detail-panel text script">
    ...
    <div class="node-tabs detail-tabs action-bar btn-toolbar" role="toolbar">
      <div class="btn-group btn-group-sm" role="group">
        ...
        <a class="source json fa fa-code btn btn-default" href="#json" data-group="json" title="JSON View"><span class="label">JSON</span></a>
        <a class="source xml fa fa-code btn btn-default hidden" href="#xml" data-group="xml" title="XML View"><span class="label">XML</span></a>
