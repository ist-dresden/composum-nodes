...
(function(b){b.console=b.console||{};b.initPermissions=function(){location.reload()};(function(d){d.getProfile=function(){return d.profile};d.getUserLoginDialog=function(){return b.getView("#user-status-dialog",d.UserLoginDialog)};d.authorize=function(a){d.getUserLoginDialog().show(void 0,a,"authorization")};d.profile={aspects:{},get:function(a,c,e){var b=d.profile.aspects[a];if(!b){var g=localStorage.getItem("composum.core."+a);g&&(b=JSON.parse(g),d.profile.aspects[a]=b)}a=void 0;b&&(a=c?b[c]:b);
return void 0!==a?a:e},set:function(a,c,b){var e=d.profile.get(a,void 0,{});c?e[c]=b:e=b;d.profile.aspects[a]=e;d.profile.save(a)},save:function(a){var c=d.profile.aspects[a];c&&localStorage.setItem("composum.core."+a,JSON.stringify(c))}};d.UserLoginDialog=b.components.Dialog.extend({initialize:function(a){b.components.Dialog.prototype.initialize.apply(this,[a]);this.$content=this.$(".modal-content");a=this.$("form");var c=this.$("button.login");a.on("submit",_.bind(this.login,this));c.click(_.bind(this.login,
this));this.$("button.logout").click(_.bind(this.logout,this));this.$el.on("shown.bs.modal",_.bind(this.onShown,this))},show:function(a,c,e){this.$content.removeClass();this.$content.addClass("modal-content");e&&this.$content.addClass(e);b.components.Dialog.prototype.show.apply(this,[a,c])},onShown:function(){this.$('input[name="j_username"]').focus()},logout:function(a){a.preventDefault();b.getHtml("/system/sling/logout.html",void 0,void 0,_.bind(function(a){this.hide();b.initPermissions()},this))},
login:function(a){a.preventDefault();this.submitForm(void 0,!1,_.bind(function(){_.isFunction(this.callback)?this.hide():b.initPermissions()},this));return!1}});d.NavBar=Backbone.View.extend({el:$("header.navbar")[0],initialize:function(){var a=$("body").attr("id");this.$(".nav-item."+a).addClass("active");a=d.getUserLoginDialog();this.$(".nav-user-status").on("click",_.bind(a.show,a))}});d.navbar=new b.console.NavBar;d.DetailTab=Backbone.View.extend({reload:function(){this.$el.closest(".detail-content")}});
d.JobControlTab=d.DetailTab.extend({initialize:function(a){d.DetailTab.prototype.initialize.apply(this,[a])},reload:function(){this.setupStatus();this.resetAuditLog()},startJob:function(a){if(!this.currentJob){var c=this.getCurrentPath();this.delay();this.logOffset=0;b.ajaxPost("/bin/cpm/core/jobcontrol.job.json",_.extend({"event.job.topic":this.jobTopic,reference:c,_charset_:"UTF-8"},a),{},_.bind(function(a,c,b){this.jobStarted(a);this.delay(!0)},this),_.bind(function(a){this.jobError("Job start failed: ",
a)},this))}},cancelJob:function(){this.currentJob&&b.ajaxDelete("/bin/cpm/core/jobcontrol.job.json/"+this.currentJob["slingevent:eventId"],{},_.bind(function(a,c,b){this.logAppend("Job cancellation requested...\n");this.delay(!0)},this),_.bind(function(a){this.jobError("Job cancellation failed: ",a)},this))},setupStatus:function(){var a=this.getCurrentPath();b.ajaxGet("/bin/cpm/core/jobcontrol.jobs.ACTIVE.json"+a+"?topic="+this.jobTopic,{},_.bind(function(a,b,d){a&&0<a.length?(this.jobStarted(a[0]),
this.delay(!0)):this.currentJob=void 0},this),_.bind(function(a){this.jobError("Job status check failed: ",a)},this))},jobStarted:function(a){a&&(this.currentJob=a,a=this.currentJob.operation,this.logOffset=0,this.$logOutput.text(""),this.resetAuditLog(),this.removeClasses(/.+-error/),this.$el.addClass((a?a:"job")+"-running"))},jobStopped:function(a){a&&this.logAppend(a);this.currentJob&&(this.removeClasses(/.+-running/),this.currentJob=void 0)},jobError:function(a,c){var b=this.currentJob.operation;
this.$el.addClass((b?b:"job")+"-error");this.jobStopped(a+c.statusText+(c.status?" ("+c.status+")":"")+"\n");this.delay(!0)},jobSucceeded:function(){this.jobStopped("Job finished successfully.\n")},checkJob:function(){this.pollOutput(_.bind(function(){this.currentJob&&(b.ajaxGet("/bin/cpm/core/jobcontrol.job.json/"+this.currentJob["slingevent:eventId"],{},_.bind(function(a,c,b){this.currentJob=a;if(this.currentJob["slingevent:finishedState"])switch(this.currentJob["slingevent:finishedState"]){case "SUCCEEDED":this.jobSucceeded();
...
"detailTab",c);this.viewWidget=void 0;for(var d=this.getTabTypes(),e=0;!this.viewWidget&&e<d.length;e++){var h=d[e];this.viewWidget=b.getWidget(this.$detailContent,h.selector,h.tabType)}this.viewWidget&&_.isFunction(this.viewWidget.reload)&&this.viewWidget.reload()},this)))},tabSelected:function(a){a.preventDefault();a=$(a.currentTarget).closest("a").attr("href").substring(1);this.selectTab(a);return!1}})})(b.console)})(window.core);
