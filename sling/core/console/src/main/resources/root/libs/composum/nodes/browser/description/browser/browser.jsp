    ...
    <div class="tab-content">
        <div id="browser-props" class="tab-pane fade active in">
            <img class="img-responsive"
                 src="${cpn:url(slingRequest,'/libs/composum/nodes/browser/description/browser/images/browser-props.png')}"
                 alt="Repository Browser and Query View"/>
        </div>
        <div id="browser-view" class="tab-pane fade">
            <img class="img-responsive"
                 src="${cpn:url(slingRequest,'/libs/composum/nodes/browser/description/browser/images/browser-view.png')}"
                 alt="Repository Browser Render View"/>
        </div>
        <div id="browser-code" class="tab-pane fade">
            <img class="img-responsive"
                 src="${cpn:url(slingRequest,'/libs/composum/nodes/browser/description/browser/images/browser-code.png')}"
