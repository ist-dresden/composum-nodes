...
# create:
# cd /Users/hps/dev/composum/private/sling/prototype/test/src/main/content
# /bin/rm -f /Users/hps/Library/Preferences/IntelliJIdea2018.3/scratches/scratch.zip
# zip -r -9 /Users/hps/Library/Preferences/IntelliJIdea2018.3/scratches/scratch.zip jcr_root/content/test/composum/pages/intermediate/site

# Actual POST
curl -u admin:admin -v -F "file=@/Users/hps/Library/Preferences/IntelliJIdea2018.3/scratches/scratch.zip" "http://localhost:9090/bin/cpm/nodes/debug/sourceupload.zip"
