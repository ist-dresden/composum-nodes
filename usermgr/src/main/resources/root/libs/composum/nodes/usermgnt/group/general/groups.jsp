...
<cpn:component var="model" type="com.composum.sling.core.usermanagement.view.Group" scope="request">
    ...
    <cpn:div test="${empty model.group.declaredModelOf}"
             class="empty-message">${cpn:i18n(slingRequest,'no relations configured')}</cpn:div>
    <cpn:div tagName="ul" test="${not empty model.group.declaredModelOf}" class="references">
        <c:forEach items="${model.group.declaredModelOf}" var="item">
