...
<cpn:component id="user" type="com.composum.sling.core.usermanagement.view.User" scope="request">
    <div id="systemuser-create-dialog" class="dialog modal fade" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content form-panel default">
                <cpn:form classes="widget-form" enctype="multipart/form-data"
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">${cpn:i18n(slingRequest,'Create New System User')}</h4>
                    </div>
