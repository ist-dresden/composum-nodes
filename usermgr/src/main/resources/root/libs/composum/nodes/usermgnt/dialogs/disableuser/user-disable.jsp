...
<cpn:component id="user" type="com.composum.sling.core.usermanagement.view.User" scope="request">
    <div id="user-disable-dialog" class="dialog modal fade" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content form-panel default">
                <cpn:form classes="widget-form" enctype="multipart/form-data"
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">${cpn:i18n(slingRequest,'Disable User')}</h4>
                    </div>
                    ...
                    <div class="modal-footer buttons">
                        ...
                        <button type="submit"
                                class="btn btn-primary create">${cpn:i18n(slingRequest,'Disable')}</button>
                    </div>
