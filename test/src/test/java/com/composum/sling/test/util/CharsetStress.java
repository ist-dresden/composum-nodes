...
public class CharsetStress {
    ...
    /**
     * Mostly for the record: a string that might trigger an XSS vulnerability.
     * <code>" onmouseover="alert('hu');" "</code>
     */
    public static String xssTest() {
        return "\" onmouseover=\"alert('hu');\" \"";
    }
