        ...
        <div class="widget code-editor-widget">
            <div class="editor-toolbar detail-toolbar">
                <div class="btn-group btn-group-sm" role="group">
                    <button type="button" class="run-script btn btn-default btn-stack"
                            title="Run Script"${browser.permissible['nodes/repository/execution']['write']?'':' disabled'}><span
                ...
                <div class="btn-group btn-group-sm" role="group">
                    <button type="button" class="start-editing fa fa-pencil btn btn-default"
                            title="Edit Script"${writeDisabled}><span class="label">Edit</span></button>
