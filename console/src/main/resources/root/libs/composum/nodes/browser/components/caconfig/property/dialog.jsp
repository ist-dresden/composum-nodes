        ...
        <cpn:form classes="widget-form default" enctype="multipart/form-data"
          ...
          <div class="modal-body">
            ...
            <div class="form-group path">
              ...
              <input name="path" class="widget property-name-widget form-control" type="text" value="${model.path}"
            ...
            <div class="row">
              ...
              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                <div class="form-group multi">
                  ...
                  <input name="multi" class="multi-select-box form-control widget checkbox-widget" type="checkbox"  onclick="return false;">
                </div>
              </div>
            </div>
