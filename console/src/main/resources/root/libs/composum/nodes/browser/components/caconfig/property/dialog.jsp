...
<sling:defineObjects/>
<div class="composum-nodes-caconfig-propertyedit dialog modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content form-panel default">
            <div class="modal-header">
                ...
                <h4 class="modal-title">${cpn:i18n(slingRequest,'Context Aware Configuration Property')}</h4>
            </div>
