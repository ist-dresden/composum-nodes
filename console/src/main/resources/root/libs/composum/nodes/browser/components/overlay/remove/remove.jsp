    ...
    <div class="modal-dialog">
        <div class="modal-content form-panel">
            <cpn:form method="POST" classes="widget-form default"
                      action="/bin/cpm/nodes/components.removeOverlay.json${cpn:path(slingRequest.requestPathInfo.suffix)}">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"
                            aria-label="${cpn:i18n(slingRequest,'Cancel')}"><span
                            aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">${cpn:i18n(slingRequest,'Remove the Overlay / Base')}</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <cpn:text class="text" i18n="true"
                                  type="rich">Do you really want to delete the current overlay / base? This cannot be undone.</cpn:text>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer buttons">
                    ...
                    <button type="submit" class="btn btn-primary">${cpn:i18n(slingRequest,'Remove')}</button>
                </div>
            </cpn:form>
        </div>
    </div>
